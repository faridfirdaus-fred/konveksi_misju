...
function Footer() {
  ...
  return (
    <footer id="footer" className="bg-gray-800 text-white py-12 md:py-16 px-4 md:px-8 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => scrollToSection('home')} className="text-white hover:text-white transition text-sm md:text-base">
                  Beranda
                </button>
              </li>
              <li>
