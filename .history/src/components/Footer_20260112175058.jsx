          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm md:text-base">
              <li className="flex items-start gap-2">
                <MdEmail className="text-xl mt-0.5 flex-shrink-0" />
                <span>konveksimisju@gmail.com</span>
              </li>
             
              
              <li className="flex items-start gap-2">
                <FaInstagram className="text-xl mt-0.5 flex-shrink-0" />
                <a href="https://instagram.com/konveksitas.misju" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                  @konveksitas.misju
                </a>
              </li>
               <li className="flex items-start gap-2">
                <MdPhone className="text-xl mt-0.5 flex-shrink-0" />
                <span>+6285318217545</span>
              </li>
              <li className="flex items-start gap-2">
                <MdLocationOn className="text-xl mt-0.5 flex-shrink-0" />
