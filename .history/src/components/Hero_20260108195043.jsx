                  ...
                  <section id="home" className="min-h-screen w-full flex items-center bg-white">
                    <div className="max-w-7xl mx-auto w-full px-6">
                      <div className="flex flex-col md:flex-row items-start gap-8">
                        <div className="w-full md:w-1/2 flex flex-col justify-center">
                          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4">
                            Tas Berkualitas Tinggi untuk Setiap Kebutuhan Anda
                          </h1>
                          <p className="text-lg md:text-xl text-gray-600 mb-6 max-w-md">
                            Kami memproduksi tas custom dengan desain eksklusif dan bahan premium. Wujudkan tas impian Anda bersama tim profesional kami.
                          </p>
                          <div className="flex flex-wrap gap-4">
                            <button onClick={() => scrollToSection('footer')} className="bg-blue-600 text-white px-6 py-3 rounded-lg text-lg font-semibold hover:bg-blue-700 transition">
                              Hubungi Kami
                            </button>
                          </div>
                        </div>
