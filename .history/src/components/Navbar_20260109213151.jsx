...
function Navbar() {
    ...
    return (
        <nav className="fixed top-0 px-20 left-0 right-0 bg-secondary shadow-md z-50">
            <div className=" mx-auto">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex space-x-8">
                        ...
                        <button onClick={() => scrollToSection('gallery')} className="text-gray-700 hover:text-primary transition">
                            Galeri
                        </button>
                        <button onClick={() => scrollToSection('about')} className="text-gray-700 hover:text-primary transition">
                            Tentang
                        </button>
                         <button onClick={() => scrollToSection('partners')} className="text-gray-700 hover:text-primary transition">
                            Mitra
                        </button>
                    </div>
                ...
                <div className="md:hidden bg-white border-t">
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="block w-full text-center px-3 py-2 bg-primary text-secondary hover:bg-secondary hover:text-primary rounded"
                        >
                            Hubungi Kami
                        </a>
                    </div>
